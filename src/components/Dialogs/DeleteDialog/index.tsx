...
import { Dialog, DialogClose, DialogContent, DialogDescription, DialogFooter, DialogTitle } from '../..';
...
export const DeleteDialog = ({
   ...
   return (
      <>
         <button className={cn('inline', `${buttonClassName}`)} onClick={() => setIsOpen(!isOpen)}>
            {trigger}
         </button>
         {isOpen || open
            ? createPortal(
               ...
               <div>
                  ...
                  <div className="mt-8 text-center">
                     <DialogTitle className="font-gorditta text-[#111111] text-2xl font-medium">
                        ...
                        {actionName?.substring?.(1)} {dialogName === 'user' ? 'User' : 'Category'}
                     </DialogTitle>
                     <div className="mt-2">
                        <DialogDescription className="text-[#4e4e4e] text-base font-normal font-gordita">
                           Are you sure you want to {actionName?.toLocaleLowerCase?.()} this{' '}
