          ...
          <div className="p-10">
            <div>
              ...
              <div className="flex justify-between gap-6 mt-8">
                <button
                  className="justify-center inline-flex flex-1 items-center  p-3 border-solid border-[1px] bg-white font-medium font-gordita text-base leading-6 text-[#111111] rounded-[1000px] select-none"
                  onClick={close}
                  disabled={loading}>
                  {cancelTitle}
                </button>
                <button
                  type="button"
                  className="justify-center inline-flex flex-1 items-center  p-3 border-solid border-[1px] bg-[#111111] font-medium font-gordita text-base leading-6 text-white rounded-[1000px]"
