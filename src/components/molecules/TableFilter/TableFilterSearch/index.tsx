  ...
  return (
    <Select onValueChange={onValueChange}>
      <SelectLabel
        ...
        className="px-3 py-[8px] space-x-2 leading-5 shadow-[0_1px_1px_0px_rgba(0,0,0,0.10),0_0_0_1px_rgba(70,79,96,0.16)] rounded-tl-md rounded-bl-md text-sm font-inter text-grey-700 tracking-[0.28px] font-medium"
      />
      <SelectContent className="top-[40px] left-0 origin-top-left mt-0 h-max">
        <SelectItemButton
          value="delete"
          id="menu-item-1"
          className="hover:bg-light-grey-2"
        >
          Delete
        </SelectItemButton>
        <SelectItemButton
  ...
  return (
    <div className="relative w-[280px]">
      ...
      <DebounceInput
        type="text"
        placeholder="Search"
        className="px-[calc(3rem-1px)] py-[6px] outline-none focus:outline-none shadow-[0_1px_1px_0px_rgba(0,0,0,0.10),0_0_0_1px_rgba(70,79,96,0.16)] rounded-tr-md rounded-br-md"
        value={filteredValue}
