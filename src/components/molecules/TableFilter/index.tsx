import { FlyOutLabel, FlyOut, FlyOutContent, FlyOutItemButton } from '@/components/molecules/FlyOut';
import { TableFilterSearch } from './TableFilterSearch';
import { AddDialog } from '@/components/Dialog/DialogContent/AddDialog';
         ...
         <div className="flex justify-between w-full items-center">
            {total > 0 && (
               <div className="flex gap-[10px] items-center">
                  <div className="font-inter text-sm font-normal leading-5 text-grey-500">{total} selected</div>
                  <TableFilterAction />
            ...
            {title && <div className="text-dark-black text-base leading-6 font-medium">{title}</div>}
